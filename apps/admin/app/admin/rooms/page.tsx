                     ...
                     <tr key={room.id} className="hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors group">
                       ...
                       <td className="p-6">
                         <div className="flex items-center gap-2">
                           <img src={room.profiles?.avatar_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(room.profiles?.full_name || 'U')}&background=0D9488&color=fff`} className="w-7 h-7 rounded-full border border-whatsapp-teal/20" alt="" />
                            ...
                            <Dialog open={roomAction?.room?.id === room.id && roomAction?.type === 'end'} onOpenChange={(open) => !open && setRoomAction(null)}>
                              ...
                              <DialogContent className="rounded-[40px] border-white/10 dark:bg-[#0f0f0f]">
                                <DialogHeader>
                                  ...
                                  <DialogDescription className="sr-only">Confirmação para encerrar a transmissão ao vivo da sala.</DialogDescription>
                                </DialogHeader>
                            ...
                            <Dialog open={roomAction?.room?.id === room.id && roomAction?.type === 'delete'} onOpenChange={(open) => !open && setRoomAction(null)}>
                              ...
                              <DialogContent className="rounded-[40px] border-white/10 dark:bg-[#0f0f0f]">
                                <DialogHeader>
                                  ...
                                  <DialogDescription className="sr-only">Confirmação para exclusão permanente dos logs da sala.</DialogDescription>
                                </DialogHeader>
                                <p className="text-sm text-gray-600 dark:text-gray-300 my-4 font-medium">
