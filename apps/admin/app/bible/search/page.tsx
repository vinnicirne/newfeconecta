...
export default function BibleSearchPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0A0A0A]">
      ...
      {/* HEADER BUSCA */}
      <div className="sticky top-0 z-50 pt-[env(safe-area-inset-top)] bg-white/80 dark:bg-[#0A0A0A]/80 backdrop-blur-xl border-b border-gray-100 dark:border-white/5">
