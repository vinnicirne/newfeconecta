...
export default function StandaloneMusicDocsPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0b1326] text-[#dae2fd] font-sans antialiased flex flex-col selection:bg-[#00A884]/30 selection:text-white">
      {/* Top Navbar Independente (Estilo Capgo/Stripe Docs) */}
      <header className="h-16 w-full border-b border-[#1e293b] bg-[#090f1e]/90 backdrop-blur-xl px-6 lg:px-10 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex items-center gap-2 text-xs font-medium text-[#94a3b8]">
            ...
            <span>•</span>
            <span>Android Media Session</span>
            <span>•</span>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className={`w-72 shrink-0 border-r border-[#1e293b] bg-[#090f1e] flex flex-col h-[calc(100vh-64px)] sticky top-16 z-40 transition-all ${
          ...
          {/* Status do App */}
          <div className="p-4 border-t border-[#1e293b]/60 text-[11px] text-[#64748b] flex items-center justify-between bg-[#070c18]">
        ...
        <main className="flex-1 overflow-y-auto bg-[#0b1326] p-6 lg:p-14 scroll-smooth">
          <div className="max-w-4xl mx-auto space-y-14">
            ...
            {(activeSection === "overview" || searchQuery) && (
              <section id="overview" className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-5 rounded-2xl bg-[#131d33]/60 border border-[#1e293b] shadow-lg">
            ...
            {(activeSection === "architecture" || searchQuery) && (
              <section id="architecture" className="space-y-6 pt-6 border-t border-[#1e293b]">
                ...
                <div className="rounded-2xl bg-[#070c18] border border-[#1e293b] p-6 font-mono text-xs overflow-x-auto leading-relaxed text-[#dae2fd] shadow-2xl">
   ...
   [ (Sem Remote Playback) ]                │
            ...
            {(activeSection === "capabilities" || searchQuery) && (
              <section id="capabilities" className="space-y-6 pt-6 border-t border-[#1e293b]">
                ...
                <ul className="space-y-3 text-sm text-[#cbd5e1]">
                  <li className="flex items-start gap-3 p-4 rounded-xl bg-[#131d33]/40 border border-[#1e293b]/50">
            ...
            {(activeSection === "public-api" || searchQuery) && (
              <section id="public-api" className="space-y-6 pt-6 border-t border-[#1e293b]">
                ...
                <div className="overflow-x-auto rounded-2xl border border-[#1e293b] bg-[#090f1e] shadow-xl">
              ...
              <section id="postmortem" className="space-y-6 pt-6 border-t border-[#1e293b]">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={idx} className="p-5 rounded-2xl bg-[#090f1e] border border-[#1e293b] space-y-3 shadow-md">
              ...
              <section id="rules" className="space-y-6 pt-6 border-t border-[#1e293b]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={idx} className="p-5 rounded-2xl bg-[#131d33]/50 border border-[#1e293b] shadow-md">
              ...
              <section id="troubleshooting" className="space-y-6 pt-6 border-t border-[#1e293b]">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.id} className="rounded-2xl bg-[#070c18] border border-[#1e293b] overflow-hidden shadow-lg">
                      <div className="flex items-center justify-between px-4 py-3 bg-[#131d33]/60 border-b border-[#1e293b] text-xs">
                      ...
                      <div className="px-4 py-2.5 bg-[#0b1326] border-t border-[#1e293b]/40 text-[11px] text-[#64748b]">
                        {item.help}
                      </div>
                    </div>
                  ))}
